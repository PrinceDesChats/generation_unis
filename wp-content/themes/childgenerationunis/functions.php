<?php
/*Ce fichier fait partie dechildgenerationunis, Divi child theme.
...
if ( ! function_exists( 'suffice_child_enqueue_child_styles' ) ) {
	function childgenerationunis_enqueue_child_styles() {
...
add_action( 'wp_enqueue_scripts', 'childgenerationunis_enqueue_child_styles' );
